  ...
  return (
    <>
      <style>{`
        ...
        @media(min-width:1320px){.guiropa-commercial-side{display:block}}@media(max-width:840px){.guiropa-commercial-top{grid-template-columns:1fr}.guiropa-commercial-top__main{grid-template-columns:1fr auto;min-height:64px;padding:10px 14px}.guiropa-commercial-top__main small{grid-column:1/-1}.guiropa-commercial-top__mini{grid-template-columns:1fr 1fr}.guiropa-commercial-mini,.guiropa-commercial-top__advertise{min-height:58px;padding:9px 11px}.guiropa-commercial-mini strong,.guiropa-commercial-top__advertise strong{font-size:11px}.guiropa-commercial-marquee__track{animation-duration:6s}.guiropa-commercial-burst{grid-template-columns:repeat(2,minmax(0,1fr))}.guiropa-commercial-burst .guiropa-commercial-link{min-height:58px;border-bottom:2px solid #17120e}.guiropa-commercial-burst strong{font-size:1rem}}@media(max-width:520px){.guiropa-commercial-burst{grid-template-columns:1fr 1fr}.guiropa-commercial-burst .guiropa-commercial-link{padding:8px 10px}.guiropa-commercial-burst small{font-size:7px}.guiropa-commercial-burst span{font-size:7px}}@media(prefers-reduced-motion:reduce){.guiropa-commercial-link::after,.guiropa-commercial-link small::before,.guiropa-commercial-link span,.guiropa-commercial-top__advertise::after,.guiropa-commercial-marquee__track{animation:none!important}}@media print{.guiropa-commercial-top,.guiropa-commercial-marquee,.guiropa-commercial-side,.guiropa-commercial-burst{display:none!important}}
      `}</style>

      <aside className="guiropa-commercial-top" aria-label="Publicidade">
        <ExternalAd href={AMAZON_MAIN} network="AMAZON" eyebrow="PUBLICIDADE · AMAZON" title="Música, vinil, áudio e cultura pop" cta="VER SELEÇÃO →" className="guiropa-commercial-top__main" />
        <div className="guiropa-commercial-top__mini">
          <ExternalAd href={SHOPEE} network="SHOPEE" eyebrow="PUBLICIDADE · SHOPEE" title="Ofertas em movimento" cta="VER →" className="guiropa-commercial-mini" />
          <Link className="guiropa-commercial-top__advertise" to="/anuncie"><small>PUBLICIDADE · GUIROPA</small><strong>Seu negócio aqui</strong><span>ANUNCIAR →</span></Link>
        </div>
      </aside>

      <div className="guiropa-commercial-marquee" aria-hidden="true"><div className="guiropa-commercial-marquee__track"><span>PUBLICIDADE · AMAZON · SHOPEE · ANUNCIE NA GUIROPA · WORLD WIRE 24H · 1950 · 1960 · 1970 · 1980 · PUBLICIDADE · AMAZON · SHOPEE ·</span><span>PUBLICIDADE · AMAZON · SHOPEE · ANUNCIE NA GUIROPA · WORLD WIRE 24H · 1950 · 1960 · 1970 · 1980 · PUBLICIDADE · AMAZON · SHOPEE ·</span></div></div>

      <aside className="guiropa-commercial-burst" aria-label="Mais publicidade">
        <ExternalAd href={AMAZON_ALT} network="DARK" eyebrow="PUBLICIDADE · AMAZON" title="Vinil, caixas, fones." cta="ABRIR →" />
        <ExternalAd href={SHOPEE} network="SHOPEE" eyebrow="PUBLICIDADE · SHOPEE" title="Garimpo do dia." cta="VER OFERTAS →" />
        <ExternalAd href={AMAZON_MAIN} network="AMAZON" eyebrow="PUBLICIDADE · AMAZON" title="Mais música. Mais loja." cta="ENTRAR →" />
        <Link className="guiropa-commercial-link" data-network="GUIROPA" to="/anuncie"><small>PUBLICIDADE · GUIROPA</small><strong>Quer aparecer aqui?</strong><span>COMPRAR ESPAÇO →</span></Link>
      </aside>

      <aside className="guiropa-commercial-side guiropa-commercial-side--left" aria-label="Oferta Amazon"><ExternalAd href={AMAZON_ALT} network="AMAZON" eyebrow="PUBLICIDADE" title="AMAZON" cta="OFERTA →" /></aside>
      <aside className="guiropa-commercial-side guiropa-commercial-side--right" aria-label="Publicidade GUIROPA"><Link className="guiropa-commercial-link" data-network="GUIROPA" to="/anuncie"><small>PUBLICIDADE</small><strong>ANUNCIE</strong><span>GUIROPA →</span></Link></aside>
    </>
  );
}
