...
export default function HomeNewsTunnel() {
  ...
  return (
    <section className="guiropa-home-news" aria-label="GUIROPA Radio News Tunnel">
      ...
      `}</style>
      <div className="guiropa-home-news__ticker" aria-hidden="true"><div className="guiropa-home-news__track"><span>GUIROPA RADIO · NEWS TUNNEL™ · WORLD WIRE · CONTINUOUS · GUIROPA RADIO · NEWS TUNNEL™ · WORLD WIRE · CONTINUOUS ·</span><span>GUIROPA RADIO · NEWS TUNNEL™ · WORLD WIRE · CONTINUOUS · GUIROPA RADIO · NEWS TUNNEL™ · WORLD WIRE · CONTINUOUS ·</span></div></div>
      <div className="guiropa-home-news__shell">
        <div className="guiropa-home-news__head">
          <div><div className="guiropa-home-news__eyebrow">GUIROPA RADIO · WORLD WIRE · LIVE</div><h2>News Tunnel™</h2></div>
        ...
        <div className="guiropa-home-news__grid">
          {items.map((item) => <a className="guiropa-home-news__card" href={item.url} target="_blank" rel="noopener noreferrer" key={item.id}><div className="guiropa-home-news__brand">GUIROPA RADIO · WORLD WIRE</div><h3>{item.title}</h3><div className="guiropa-home-news__foot"><span>{item.region || "WORLD"}</span><span>{stamp(item.publishedAt || item.discoveredAt)}</span></div></a>)}
        </div>
