...
export default function HomePage(){
  ...
  return <main className="guiropa-radio-home guiropa-home-portal">
    <style>{`
      .guiropa-home-portal{background:#f4ead7;color:#211a15}.guiropa-home-portal__shell{width:min(1180px,calc(100% - 40px));margin:0 auto}.guiropa-home-portal__ad{position:relative;overflow:hidden;background:#b83224;color:#fff;border-block:1px solid #8f241b}.guiropa-home-portal__ad:after{content:"ANUNCIE";position:absolute;right:-3vw;bottom:-3vw;color:rgba(255,255,255,.07);font-size:clamp(7rem,20vw,18rem);font-weight:900;line-height:.75;letter-spacing:-.09em}.guiropa-home-portal__ad-grid{position:relative;z-index:1;min-height:500px;padding:clamp(3.8rem,7vw,6rem) 0;display:grid;grid-template-columns:minmax(0,1.2fr) minmax(300px,.55fr);gap:clamp(2.5rem,6vw,5rem);align-items:center}.guiropa-home-portal__ad-eyebrow{display:block;color:#ffe3cf;font-size:.64rem;font-weight:900;letter-spacing:.2em}.guiropa-home-portal__ad h2{max-width:9.5ch;margin:.8rem 0 0;font-size:clamp(3.5rem,7vw,7.2rem);font-weight:900;line-height:.82;letter-spacing:-.07em}.guiropa-home-portal__ad p{max-width:720px;margin:1.5rem 0 0;color:#ffe9df;font-size:clamp(.95rem,1.5vw,1.15rem);line-height:1.65}.guiropa-home-portal__ad-offer{padding-left:30px;border-left:1px solid rgba(255,255,255,.4)}.guiropa-home-portal__ad-offer strong{display:block;font-size:clamp(3.2rem,6vw,6rem);line-height:.82;letter-spacing:-.07em}.guiropa-home-portal__ad-spots{display:block;margin-top:16px;font-size:.7rem;font-weight:900;letter-spacing:.13em}.guiropa-home-portal__ad .guiropa-home-portal__button{margin-top:24px;background:#17120e;color:#fff;border-color:#17120e}.guiropa-home-portal__button{display:inline-flex;align-items:center;justify-content:center;min-height:48px;padding:0 18px;border:1px solid #211a15;background:#211a15;color:#fff4df;text-decoration:none;font-size:.62rem;font-weight:900;letter-spacing:.1em}.guiropa-home-portal__button:hover{background:#fff;color:#211a15}.guiropa-home-feature{padding:clamp(3.5rem,6vw,5rem) 0;background:#f7eedf}.guiropa-home-feature__grid{display:grid;grid-template-columns:minmax(220px,.7fr) minmax(0,1.3fr);gap:clamp(2rem,5vw,4rem);align-items:center}.guiropa-home-feature img{display:block;width:100%;max-height:390px;object-fit:cover;object-position:center;border-radius:18px;filter:grayscale(1)}.guiropa-home-feature__eyebrow{color:#b83224;font-size:.6rem;font-weight:900;letter-spacing:.2em}.guiropa-home-feature h2{margin:.7rem 0 0;font-family:Georgia,"Times New Roman",serif;font-size:clamp(3rem,6vw,5.5rem);font-weight:400;line-height:.9;letter-spacing:-.055em}.guiropa-home-feature p{max-width:620px;color:#766654;font-size:clamp(1.1rem,2vw,1.6rem);line-height:1.4}.guiropa-home-support{padding:clamp(3.5rem,6vw,5rem) 0;background:#17120e;color:#f5ead6;border-top:1px solid #332419}.guiropa-home-support__grid{display:grid;grid-template-columns:minmax(0,1fr) auto;gap:30px;align-items:end}.guiropa-home-support__eyebrow{color:#d9b467;font-size:.62rem;font-weight:900;letter-spacing:.19em}.guiropa-home-support h2{max-width:800px;margin:.8rem 0 0;font-family:Georgia,"Times New Roman",serif;font-size:clamp(2.5rem,5vw,4.8rem);font-weight:400;line-height:.95;letter-spacing:-.05em}.guiropa-home-support p{max-width:720px;color:#aa9984;line-height:1.7}.guiropa-home-support a{display:inline-flex;min-height:48px;align-items:center;padding:0 18px;background:#b83224;color:#fff5e7;text-decoration:none;font-size:.62rem;font-weight:900;letter-spacing:.11em;white-space:nowrap}@media(max-width:760px){.guiropa-home-portal__shell{width:min(100% - 24px,650px)}.guiropa-home-portal__ad-grid,.guiropa-home-feature__grid,.guiropa-home-support__grid{grid-template-columns:1fr}.guiropa-home-portal__ad-grid{min-height:auto}.guiropa-home-portal__ad-offer{padding:24px 0 0;border-left:0;border-top:1px solid rgba(255,255,255,.4)}.guiropa-home-portal__ad h2{font-size:clamp(3rem,15vw,5rem)}.guiropa-home-feature img{max-height:320px}.guiropa-home-support a{justify-self:start}}
    `}</style>
    <Hero />
    <ExploreHub />
    <HomeLiveAgenda />
